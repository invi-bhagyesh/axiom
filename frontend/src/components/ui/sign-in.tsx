      ...
      {(heroImageSrc || heroElement) && (
        <section className="hidden md:block flex-1 relative p-4">
          {heroElement ? (
            ...
            <div className="animate-slide-right animate-delay-300 absolute inset-4 rounded-3xl flex flex-col items-center justify-center overflow-hidden"
              style={{ background: 'radial-gradient(ellipse at 30% 30%, rgba(0,40,60,0.8) 0%, #0c0d10 70%)' }}>
              <img src={heroImageSrc} alt="" className="mb-6" style={{ imageRendering: 'pixelated', width: 320, filter: 'drop-shadow(0 0 40px rgba(0,212,255,0.15))' }} />
              <p className="font-serif italic text-[28px] tracking-tight" style={{ color: 'rgba(255,255,255,0.12)' }}>Axiom</p>
              <p className="text-[11px] uppercase tracking-[4px] mt-1" style={{ color: 'rgba(255,255,255,0.06)' }}>Human Annotation Platform</p>
            </div>
          )}
